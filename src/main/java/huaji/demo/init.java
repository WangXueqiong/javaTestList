...
public class init {
    public static void main(String[] args) throws IOException {
        ...
        ballimg.add(ImageIO.read(new File("src\\huaji\\img\\huaji2.png")));
        ballimg.add(ImageIO.read(new File("src\\huaji\\img\\huaji4.png")));
        ballimg.add(ImageIO.read(new File("src\\huaji\\img\\huaji3.png")));
